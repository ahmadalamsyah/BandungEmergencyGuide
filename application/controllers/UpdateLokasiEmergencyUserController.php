...
/**
 * Description of UpdateLokasiEmergencyUserController
 *
 * @author AhmadAlamsyah
 */
class UpdateLokasiEmergencyUserController extends CI_Controller {
    //put your code here
	...
	public function index()        
	{
		...
		$this->load->view('useremergency/UpdateLokasiEmergencyViewUser',$tempat);
