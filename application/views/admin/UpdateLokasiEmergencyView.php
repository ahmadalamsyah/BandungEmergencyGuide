       ...
       function getMarker(){
        ...
        $(document).ready(function(){
               ...
               if(namaLokasi == '' ||  alamatLokasi == '' || noTlp == '' || latitude == '' || longitude == '' || kategoriTempat == ''){
                   ...
                   $.ajax({
                        type:"POST",
                        url: "<?php echo base_url()?>LokasiEmergencyController/updateLokasiEmergency",
                        ...
                        success: function (data) {
                            alert ("insert berhasil");
                                ...
                                window.location = "<?php echo base_url() ?>HomeController";
                        },
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse">
			...
			<li><a href="<?php echo base_url() ;?>HomeController">Home</a></li>
                        <li ><a href="<?php echo base_url();?>LokasiEmergencyController">Tambah Lokasi <b class="caret"></b></a>
