...
//       var logitude = new array();
            ...
            url = "<?php echo base_url();?>LokasiEmergencyController/getInformationLocation";
                $.getJSON(url,function(data){
                    $.each(data.marker,function(key,marker){
                        ...
                        if(marker.idKategoriTempat == 'PL1000'){
                            var image = '<?php echo base_url();?>assets/img/police3.png';
                        }else if(marker.idKategoriTempat == 'RS2000'){
                            var image = '<?php echo base_url();?>assets/img/hospital.png';
                        }else{
                            
                            var image = '<?php echo base_url();?>assets/img/puskesmas.png';
                        }
    ...
    <script>
         $(document).ready(function(){
               ...
               var element = $(this);
               var idLokasiEmergencyHapus = element.attr("idLokasiEmergencyHapus");
               alert(idLokasiEmergencyHapus);
               if(confirm("Apakah Data Lokasi Akan Di Hapus")){
                  $.ajax({
                        type:"POST",
                        url: "<?php echo base_url()?>LokasiEmergencyController/deleteLokasiEmergency",
                        data: 'idLokasiEmergencyHapus='+idLokasiEmergencyHapus,
                        success: function (data) {
                            alert ("Delete Berhasil berhasil");
                    ...
                    <tbody>
                           <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="<?php echo base_url()?>LokasiEmergencyController/getOpenEdit/<?php echo $row->idLokasiEmergency?>" >Edit</a>
