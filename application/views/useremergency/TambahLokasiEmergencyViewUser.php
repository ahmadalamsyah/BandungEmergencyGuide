...
//       var logitude = new array();
       function getMarker(){
          var idKategoriTempat= 'PL1000';
           var koorAwal = new google.maps.LatLng(-6.915239, 107.612409);
            ...
            var peta = new google.maps.Map(document.getElementById("kanvaspeta"),settingpeta);
            url = "<?php echo base_url();?>LokasiEmergencyUserController/getInformationLocation";
    ...
    <script>
        $(document).ready(function(){
               ...
               if(namaLokasi==''||alamatLokasi==''||noTlp==''||latitude==''||latitude==''){
                   ...
                   return false;
                    ...
                    $.ajax({
                        type:"POST",
                        url: "<?php echo base_url()?>LokasiEmergencyUserController/simpanLokasiEmergency",
